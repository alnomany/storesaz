...
class Utility extends Model
{
    ...
    public static function themeOne()
    {
        ...
        $arr = [
            'theme1' => [
                'theme1-v1' => [
                    'img_path' => asset(Storage::url('uploads/store_theme/theme1/Home0.png')),
                    'color' => '92bd88',
                ],
                'theme1-v2' => [
            ...
            'theme2' => [
                'theme2-v1' => [
                    'img_path' => asset(Storage::url('uploads/store_theme/theme2/Home0.png')),
                    'color' => 'f5ba20',
                ],
                'theme2-v2' => [
...
// chart of account for new company Utility::chartOfAccountData1
