                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            @foreach ($purchases as $purchase)
                                ...
                                <tr>
                                    <td class="Id">
                                        <a href="{{ route('purchase.show',\Crypt::encrypt($purchase->id)) }}" class="btn btn-outline-primary">{{ $purchase->purchase_id }}</a>

                                    </td>

                                    <td> {{ (!empty( $purchase->supplier)?$purchase->supplier->name:'') }} </td>

                                    <td>{{-- !empty($purchase->category)?$purchase->category->name:''--}}</td>
                                    <td>{{ Auth::user()->dateFormat($purchase->date) }}</td>
