                        ...
                        <div class="card-body">
                            <div class="row timeline-wrapper">
                                <div class="col-md-6 col-lg-4 col-xl-4 create_invoice">
                                    ...
                                    <p class="text-muted text-sm mb-3"><i class="ti ti-clock mr-2"></i>{{__('Created on ')}}{{$purchase->purchase_date}}</p>
                                    @can('edit purchase')
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4 send_invoice">
                                    ...
                                    <p class="text-muted text-sm mb-3">
                                        @if($purchase->status!=0)
                                            <i class="ti ti-clock mr-2"></i>{{__('Sent on')}} {{$purchase->send_date}}
                                        @else
                                          {{-- @can('send purchase')--}}  
                                        ...
                                        <table class="table ">
                                            ...
                                            @foreach($iteams as $key =>$iteam)
                                                ...
                                                @endphp
                                                                ...
                                                                @php
                                                                    ...
                                                                    if (!empty($iteam->tax)) {
                                                                        foreach (explode(',', $iteam->tax) as $tax) {
                                                                            ...
                                                                            $itemTax['price'] = \Auth::user()->$taxPrice;
                                                    ...
                                                    <td class="text-end">{{($iteam->price * $iteam->quantity - $iteam->discount) + $totalTaxPrice}}</td>
                                                </tr>
                                            @endforeach
                                            <tfoot>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">{{$purchase->getTotalDiscount()}}</td>
                                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-end">{{$purchase->getTotal()}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-end"><b>{{__('Paid')}}</b></td>
                                                <td class="text-end">{{($purchase->getTotal()-$purchase->getDue())}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-end"><b>{{__('Due')}}</b></td>
                                                <td class="text-end">{{$purchase->getDue()}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                        ...
                        <table class="table">
                            ...
                            @forelse($purchase->payments as $key =>$payment)
                                <tr>
                                    ...
                                    <td>{{--!empty($payment->bankAccount)?$payment->bdankAccount->bank_name.' '.$payment->bankAccount->holder_name:''--}}</td>
