        ...
        $(document).on('change', '.item', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (item.product_taxes == 0) {
                        product_taxes += '-';
                    } else {


                        for (var i = 0; i < item.product_taxes.length; i++) {


                            product_taxes += '<span class="badge bg-primary mt-1 mr-2">' + item.product_taxes[i].name + ' ' + '(' + item.product_taxes[i].rate + '%)' + '</span>';
                            tax.push(item.product_taxes[i].id);
                            totalItemTaxRate += parseFloat(item.product_taxes[i].rate);
                    ...
                    $(el.parent().parent().find('.taxes')).html(product_taxes);
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="taxes"></div>
                                            {{ Form::hidden('product_tax','', array('class' => 'form-control tax')) }}
