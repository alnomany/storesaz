                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table mb-0 table-striped">
                                                ...
                                                @if(!empty($item->product_id))
                                                        <tr>
                                                           ...
                                                           {{--  <td>$item->quantity . ' (' . $productName->unit->name . ')' </td>--}}
                                                            ...
                                                            <td class="text-end">{{($item->price * $item->quantity - $item->discount) + $totalTaxPrice}}</td>
                                                            <td></td>
                                                        </tr>
                                                    @else
                                                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><b>{{$expense->getAccountTotal()}}</b></td>

                                            </tr>
                                            <tr>
                                                <td colspan="8"></td>
                                                <td class="text-end"><b>{{__('Sub Total')}}</b></td>
                                                <td class="text-end">{{$expense->getSubTotal()}}</td>
                                            </tr>

                                                <tr>
                                                    <td colspan="8"></td>
                                                    <td class="text-end"><b>{{__('Discount')}}</b></td>
                                                    <td class="text-end">{{$expense->getTotalDiscount()}}</td>
                                                </tr>
