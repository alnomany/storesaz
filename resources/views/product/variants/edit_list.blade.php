    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="vpurchase_price_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ __('Enter Price') }}" class="form-control wid-100"
                    name="{{ $name['purchase_price'] }}" value="{{ $name['purchase_price_val'] }}">
                </td>
                <td>
