...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{Form::label('phone_number',__('Number'),['class'=>'form-label'])}}
                {{Form::number('phone_number',null,array('class'=>'form-control','required'=>'required' , 'placeholder'=>__('Enter Contact Number')))}}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                {{Form::text('tax_number',null,array('class'=>'form-control' , 'placeholder' => __('tax_number')))}}
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                {{Form::text('billing_phone',null,array('class'=>'form-control' , 'placeholder'=>__('Phone')))}}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
