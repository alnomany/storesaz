...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($sup_logo.'/favicon.png' . '?timestamp='. time()); ?>" type="image/x-icon" />
                ...
                <nav class="navbar navbar-expand-md  default top-nav-collapse">
                    <div class="header-left">
                        <a class="navbar-brand bg-transparent" href="#">
                            <img src="<?php echo e($logo.'/'. $settings['site_logo'] . '?timestamp='. time()); ?>" alt="logo" height="30px" width="130px">
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                                <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($value->header) && $value->header == 'on'): ?>
                                        <li class="nav-item">
                                            <a class="nav-link"
                                                href="<?php echo e((isset($value->template_name) && $value->template_name == 'page_content') ? route('custom.page', $value->page_slug) :  $value->page_url); ?>"><?php echo e($value->menubar_page_name); ?></a>
                                        </li>
                                    <?php endif; ?>
        ...
        <section class="main-banner bg-primary" id="home">
            ...
            <div class="container">
                <div class="row g-0 gy-2 mt-4 align-items-center">
                    <div class="col-xxl-3">
                        <?php if($settings['home_trusted_by']): ?>
            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-center mb-4">
                    ...
                    <div class="col-lg-7 col-md-6 res-img">
                        <?php if(File::exists(storage_path('/uploads/landing_page_image/' . $value['other_features_image']))): ?>
            ...
            <div class="row gy-4 gx-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="screenshot-card">
                        <?php if(File::exists(storage_path('/uploads/landing_page_image/' . $value['screenshots']))): ?>
                            <div class="img-wrapper">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none <?php echo e($key == 2 ? 'bg-dark' : ""); ?>">
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 display-3"><?php echo e(isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'].$value->price : '$'.$value->price); ?><small
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->max_users != 0 ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_users >= 0 ? $value->max_users : __("Unlimited")); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->max_stores != 0 ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_stores >= 0 ? $value->max_stores : __("Unlimited")); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->max_products != 0 ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>  
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_products >= 0 ? $value->max_products : __("Unlimited")); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->storage_limit != 0 ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->storage_limit >= 0 ? $value->storage_limit : __("Unlimited")); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->enable_custdomain != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->enable_custsubdomain != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->enable_custsubdomain =='on' ? 'Enable' : 'Disable'); ?> <?php echo e(__('Sub Domain')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->shipping_method != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->shipping_method =='on' ? 'Enable' : 'Disable'); ?> <?php echo e(__('Shipping Method')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->additional_page != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->additional_page =='on' ? 'Enable' : 'Disable'); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->blog != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->blog =='on' ? 'Enable' : 'Disable'); ?> <?php echo e(__('Blog')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->pwa_store != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->pwa_store =='on' ? 'Enable' : 'Disable'); ?> <?php echo e(__('Progressive Web App (PWA)')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <i class="<?php echo e($value->enable_chatgpt != 'off' ? 'text-primary ti ti-circle-plus' : 'text-danger ti ti-circle-minus'); ?>"></i>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->enable_chatgpt == 'on' ? 'Enable' : 'Disable'); ?> <?php echo e(__('Chatgpt')); ?></label>
                                        </div>
                                    </li>
    ...
    <footer class="site-footer bg-gray-100">
            ...
            <div class="footer-row">
                        ...
                        <?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                            <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($value->footer == 'on' && $value->header == 'off'): ?>
                                        <li><a href="<?php echo e((isset($value->template_name) && $value->template_name == 'page_content') ? route('custom.page',$value->page_slug) :  $value->page_url); ?>"><?php echo $value->menubar_page_name; ?></a></li>
                                    <?php endif; ?>
                                    <?php if($value->footer == 'on' && $value->header == 'on'): ?>
                                        <li><a href="<?php echo e((isset($value->template_name) && $value->template_name == 'page_url') ? $value->page_url :  route('custom.page',$value->page_slug)); ?>"><?php echo $value->menubar_page_name; ?></a></li>
                                    <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </ul>
                ...
                <div class="ftr-col">
                    <ul class="list-unstyled">
                        <?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                            <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($value->footer == 'off' && $value->header == 'on'): ?>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="<?php echo e((isset($value->template_name) && $value->template_name == 'page_content') ? route('custom.page', $value->page_slug) :  $value->page_url); ?>"><?php echo e($value->menubar_page_name); ?></a>
                                    </li>
        ...
        <div class="border-top border-dark text-center p-2">
            <p class="mb-0"> &copy;
                ...
                <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Storego Saas')); ?>
...
<?php /**PATH C:\laragon\www\codecanyon-xQmcGESZ-storego-saas-online-store-builder\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>